...
- [docs/bitbucket-merge-watch.md](docs/bitbucket-merge-watch.md) - how the merge watch follows a Bitbucket Cloud pull request and reads its build verdict, and the evidence behind it.
