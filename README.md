...
- [docs/bitbucket-merge-watch.md](docs/bitbucket-merge-watch.md) - how the merge watch follows a Bitbucket Cloud pull request, reads its build verdict, and performs the guarded merge action, the evidence behind it, and the current gap where the watcher does not run the Bitbucket poll.
