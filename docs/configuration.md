...
FM_WEDGE_UNREADABLE_SURFACE_COUNT=3  # consecutive unreadable crew-state probes on a stale pane before the reader failure itself is surfaced (never as a wedge or a stop); the count resets on any readable verdict
