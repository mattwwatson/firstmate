...
FM_IDENTITY_MAX_DEPTH=4    # max find depth of fm-identity-check.sh's per-`includeIf gitdir:` subtree scan for governed remotes
FM_IDENTITY_MAX_REPOS=400  # repositories visited per fm-identity-check.sh subtree scan before it stops and cautions
