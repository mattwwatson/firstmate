...
That one sighting is recorded against the pause itself, not against the pane's contents, so an idle harness pane that merely repaints cannot ask for it again.
