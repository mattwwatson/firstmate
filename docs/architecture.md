...
`config/herdr-child-workspaces` is inherited too; the primary's default-off Herdr space-per-crewmate opt-in therefore converges across every secondmate home.
